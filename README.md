...
<p align="center">
  <img src="frontend/static/logo.png" alt="Horizons logo" width="320" />
</p>
...
| Winner | Condition |
|--------|-----------|
| Residents | All 3 tasks per resident completed, then nuke launched (50/50 gamble at launch pad) |
| Residents | All aliens eliminated |
| Aliens | Kill residents until aliens are >= residents alive |
| Aliens | Let a sabotage fire burn unchecked for 60 seconds |
...
World: **3000 x 1500**. Left half (x 0-1500) is Russia; right half (x 1500-3000) is the USA. Each half is drawn square (1500 x 1500) to match the 20000 x 20000 source images.
...
| Audio | Web Audio API procedural tones + sampled clips from Google's free sound library |
